        ...
        <div class="container wrapper">
            <div class="row" style="margin:-5px;">
                <div id="sideInfo" class="span3 module" style="padding:12px;">
                    <img width="210px" height="210px" src="<s:property value="student.pic.content"/>" class="img-polaroid"/>
                                    ...
                                    <s:iterator value="classList" id="list">
                                        <s:if test="status>=2">
                                            <tr>
                                                <td>
                                                    <blockquote>
                                                        <h4><a href="/${freeTime.teacher.email}">
                                                                <s:property value="freeTime.teacher.name"/></a>
